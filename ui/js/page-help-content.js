...
export const PAGE_HELP = {
  ...
  postprocess: {
    ...
    sections: [
      ...
      { title: "Advanced AI Upscaler", text: "Uses an AI model to enlarge images by the same amount. Choose Install model & libraries before using it. The download includes a 67 MB model and its required libraries; allow roughly 150–250 MB of disk space. On Macs, it tries to use the graphics processor (GPU) when supported; otherwise it uses the main processor (CPU). Windows and Linux currently use the CPU. CPU-only runs can take considerably longer, especially for a large deck." },
